    ...
    var axilInit = {
        ...
        quantityRanger: function() {
            ...
            $('.qtybtn').on('click', function() {
                ...
                //var cambio = parseFloat($('#canti'+ id).val());
                //var id = $('#ids').val();
                ...
                //$('#etiqueta subtotal').val(valor a agregar)
                $('#subtotales'+id).val(subtota1);
                console.log(id);
                for(var i = 1; i < 4; i++){
                    var gasto = parseFloat($('#canti'+ i).val());
                    var cati = $button.parent().find('input').attr('class').split(' ')[0].split('-')[1];
                    var cambio = parseFloat($('#cambio'+ i).val());
                    //subtota2 = subtota2 ()
                    total = total + (cambio * gasto);
                    var Iva = total * 0.16;
                    var totales = Iva + total;
                    console.log(cati);
                    console.log(total);
                    gasto = 0;
                    cati = 0;
                ...
                $('#sumaT').val(total);
                $('#iva').val(Iva.toFixed(1));
                $('#Total').val(totales.toFixed(1));
                //console.log(total);
                //console.log(subtota1);
                //console.log(subtota2);
                //console.log(subtota3);
            });
        },
